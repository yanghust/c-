		...
		case 16 :
				  {
					...
					int y0=y;
					int x0=x;
					hzk_p = fopen("c:\\borlandc\\hzk16","rb");            //使用相对路径
					if(hzk_p==NULL)
					{
						printf("Can't open hzk16 file!Press any key to quit...");
						getch();
						exit(1);
					}
					while(*s!=NULL)
		...
		case 24 :
				  {
					...
					int y0=y;
					int x0=x;
					hzk_p = fopen("c:\\borlandc\\hzk24k","rb");
					if (hzk_p==NULL)
					{
						printf("Can't open hzk24 file!Press any key to quit...");
						getch();
						exit(1);
		...
		case 32 :
				  {
					...
					int y0=y;
					int x0=x;
					hzk_p = fopen("c:\\borlandc\\hzk32s","rb");
					if(hzk_p==NULL)
					{
						printf("Can't open hzk32 file!Press any key to quit...");
						getch();
						exit(1);
		...
		case 48:
				  {
					...
					int y0=y;
					int x0=x;
					hzk_p = fopen("c:\\borlandc\\hzk48k","rb");
					if(hzk_p==NULL)
					{
						printf("Can't open hzk48 file!Press any key to quit...");
						getch();
						exit(1);
